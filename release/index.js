...
// CONCATENATED MODULE: ./node_modules/ngx-perfect-scrollbar/dist/ngx-perfect-scrollbar.es5.js
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PerfectScrollbarComponent", function() { return ngx_perfect_scrollbar_es5_PerfectScrollbarComponent; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PerfectScrollbarDirective", function() { return ngx_perfect_scrollbar_es5_PerfectScrollbarDirective; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PerfectScrollbarModule", function() { return ngx_perfect_scrollbar_es5_PerfectScrollbarModule; });
 ...
 */
/** @type {?} */
var PERFECT_SCROLLBAR_CONFIG = new core_["InjectionToken"]('PERFECT_SCROLLBAR_CONFIG');
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var ngx_perfect_scrollbar_es5_PerfectScrollbarDirective = /** @class */ (function () {
    function PerfectScrollbarDirective(zone, differs, elementRef, platformId, defaults) {
        ...
        this.ngDestroy = new external__rxjs_["Subject"]();
        this.disabled = false;
        this.psScrollY = new core_["EventEmitter"]();
        this.psScrollX = new core_["EventEmitter"]();
        this.psScrollUp = new core_["EventEmitter"]();
        this.psScrollDown = new core_["EventEmitter"]();
        this.psScrollLeft = new core_["EventEmitter"]();
        this.psScrollRight = new core_["EventEmitter"]();
        this.psYReachEnd = new core_["EventEmitter"]();
        this.psYReachStart = new core_["EventEmitter"]();
        this.psXReachEnd = new core_["EventEmitter"]();
        this.psXReachStart = new core_["EventEmitter"]();
    }
    /**
     * @return {?}
     */
    ...
    function () {
        var _this = this;
        if (!this.disabled && Object(common_["isPlatformBrowser"])(this.platformId)) {
            /** @type {?} */
             ...
             */
            function () {
                _this.ro = new ResizeObserver_es["a" /* default */]((/**
                 * @return {?}
                 */
                function () {
                    _this.update();
            ...
            function () {
                ...
                function (eventName) {
                    ...
                    Object(external__rxjs_["fromEvent"])(_this.elementRef.nativeElement, eventType)
                        .pipe(Object(operators_["auditTime"])(20), Object(operators_["takeUntil"])(_this.ngDestroy))
                        .subscribe((/**
                     * @param {?} event
                     * @return {?}
                     */
    ...
    function () {
        var _this = this;
        if (Object(common_["isPlatformBrowser"])(this.platformId)) {
            this.ngDestroy.next();
     ...
     */
    function () {
        if (!this.disabled && this.configDiff && Object(common_["isPlatformBrowser"])(this.platformId)) {
            /** @type {?} */
     ...
     */
    function (changes) {
        if (changes['disabled'] && !changes['disabled'].isFirstChange() && Object(common_["isPlatformBrowser"])(this.platformId)) {
    ...
    PerfectScrollbarDirective.ctorParameters = function () { return [
        { type: core_["NgZone"] },
        { type: core_["KeyValueDiffers"] },
        { type: core_["ElementRef"] },
        { type: Object, decorators: [{ type: core_["Inject"], args: [core_["PLATFORM_ID"],] }] },
        { type: undefined, decorators: [{ type: core_["Optional"] }, { type: core_["Inject"], args: [PERFECT_SCROLLBAR_CONFIG,] }] }
    ]; };
    PerfectScrollbarDirective.propDecorators = {
        disabled: [{ type: core_["Input"] }],
        config: [{ type: core_["Input"], args: ['perfectScrollbar',] }],
        psScrollY: [{ type: core_["Output"] }],
        psScrollX: [{ type: core_["Output"] }],
        psScrollUp: [{ type: core_["Output"] }],
        psScrollDown: [{ type: core_["Output"] }],
        psScrollLeft: [{ type: core_["Output"] }],
        psScrollRight: [{ type: core_["Output"] }],
        psYReachEnd: [{ type: core_["Output"] }],
        psYReachStart: [{ type: core_["Output"] }],
        psXReachEnd: [{ type: core_["Output"] }],
        psXReachStart: [{ type: core_["Output"] }]
    };
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var ngx_perfect_scrollbar_es5_PerfectScrollbarComponent = /** @class */ (function () {
    function PerfectScrollbarComponent(zone, cdRef, platformId) {
        ...
        this.ngDestroy = new external__rxjs_["Subject"]();
        this.stateUpdate = new external__rxjs_["Subject"]();
        this.disabled = false;
    ...
    function () {
        ...
        if (Object(common_["isPlatformBrowser"])(this.platformId)) {
            this.stateUpdate
                .pipe(Object(operators_["takeUntil"])(this.ngDestroy), Object(operators_["distinctUntilChanged"])((/**
             * @param {?} a
             * @param {?} b
             * @return {?}
             */
            ...
            function () {
                if (_this.directiveRef) {
                    ...
                    Object(external__rxjs_["fromEvent"])(element, 'wheel')
                        .pipe(Object(operators_["takeUntil"])(_this.ngDestroy))
                        .subscribe((/**
                     * @param {?} event
                     * @return {?}
                     */
                    ...
                    Object(external__rxjs_["fromEvent"])(element, 'touchmove')
                        .pipe(Object(operators_["takeUntil"])(_this.ngDestroy))
                        .subscribe((/**
                     * @param {?} event
                     * @return {?}
                    ...
                    Object(external__rxjs_["merge"])(Object(external__rxjs_["fromEvent"])(element, 'ps-scroll-x')
                        .pipe(Object(operators_["mapTo"])('x')), Object(external__rxjs_["fromEvent"])(element, 'ps-scroll-y')
                        .pipe(Object(operators_["mapTo"])('y')), Object(external__rxjs_["fromEvent"])(element, 'ps-x-reach-end')
                        .pipe(Object(operators_["mapTo"])('right')), Object(external__rxjs_["fromEvent"])(element, 'ps-y-reach-end')
                        .pipe(Object(operators_["mapTo"])('bottom')), Object(external__rxjs_["fromEvent"])(element, 'ps-x-reach-start')
                        .pipe(Object(operators_["mapTo"])('left')), Object(external__rxjs_["fromEvent"])(element, 'ps-y-reach-start')
                        .pipe(Object(operators_["mapTo"])('top')))
                        .pipe(Object(operators_["takeUntil"])(_this.ngDestroy))
                        .subscribe((/**
                     * @param {?} state
                     * @return {?}
    ...
    PerfectScrollbarComponent.propDecorators = {
        disabled: [{ type: core_["Input"] }],
        usePSClass: [{ type: core_["Input"] }],
        autoPropagation: [{ type: core_["HostBinding"], args: ['class.ps-show-limits',] }, { type: core_["Input"] }],
        scrollIndicators: [{ type: core_["HostBinding"], args: ['class.ps-show-active',] }, { type: core_["Input"] }],
        config: [{ type: core_["Input"] }],
        psScrollY: [{ type: core_["Output"] }],
        psScrollX: [{ type: core_["Output"] }],
        psScrollUp: [{ type: core_["Output"] }],
        psScrollDown: [{ type: core_["Output"] }],
        ...
        psXReachEnd: [{ type: core_["Output"] }],
        psXReachStart: [{ type: core_["Output"] }],
        directiveRef: [{ type: core_["ViewChild"], args: [ngx_perfect_scrollbar_es5_PerfectScrollbarDirective, { static: true },] }]
    };
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var ngx_perfect_scrollbar_es5_PerfectScrollbarModule = /** @class */ (function () {
    function PerfectScrollbarModule() {
    }
    PerfectScrollbarModule.decorators = [
        { type: core_["NgModule"], args: [{
                    imports: [common_["CommonModule"]],
                    declarations: [ngx_perfect_scrollbar_es5_PerfectScrollbarComponent, ngx_perfect_scrollbar_es5_PerfectScrollbarDirective],
                    exports: [common_["CommonModule"], ngx_perfect_scrollbar_es5_PerfectScrollbarComponent, ngx_perfect_scrollbar_es5_PerfectScrollbarDirective]
                },] }
    ];
